/**
 * VA Studio Frontend — AI Assistant Standalone
 *
 * This is a standalone version of the AI Assistant template.
 * It renders the AI Assistant template directly as the main interface.
 *
 * Routes:
 *   /  → AI Assistant template (default)
 *
...
import TemplateApp from '../templates/aiassistant/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (AI Assistant Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
